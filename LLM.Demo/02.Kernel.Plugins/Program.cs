...
while (true)
{
    ...
    Console.WriteLine("1. Invoke the kernel with a prompt that asks the AI for information it cannot provide and may hallucinate");
    ...
    Console.WriteLine("4. Invoke the kernel with a prompt and allow the AI to automatically invoke functions that use enumerations");
...
{
    [KernelFunction]
    [Description("Retrieves the current time in UTC. A calendar tool.")]
